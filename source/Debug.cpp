...
void ___LNetDebug::___debug_create_log_level(const std::string& _level_name)
{
	if(___AVAILIBLE_LOG_LEVELS.find(_level_name) == ___AVAILIBLE_LOG_LEVELS.end())
		___AVAILIBLE_LOG_LEVELS.emplace(_level_name, false);
}

void ___LNetDebug::___debug_remove_log_level(const std::string& _level_name)
{
...
void ___LNetDebug::___debug_log(const std::string& _level_name, const std::string& _message)
{
	if(___AVAILIBLE_LOG_LEVELS.find(_level_name) != ___AVAILIBLE_LOG_LEVELS.end())
